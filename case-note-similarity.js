(function () {
  ...
  const standardNote = [
    ...
    "그 이유는 AI를 어떤 목적으로 사용할지 스스로 올바르게 판단하지 못하고, 성적을 위해 시험 문제를 AI에 입력하는 잘못된 선택을 했기 때문이다."
  ].join("\n");
  ...
  const rubric = [
    ...
    },
    {
      ...
      checks: [
        ...
        { label: "AI 사용 목적을 스스로 올바르게 판단하지 못한 이유 제시", points: 8, patterns: [/목적.*판단/, /올바르게.*판단/, /스스로.*판단/, /성적.*(AI|ai|입력|선택)/, /시험\s*문제.*(AI|ai|입력)/, /잘못된\s*선택/] }
      ]
    }
  ];
